...
import { EntradaEstoqueFilterDto } from '@entrada-estoque/interfaces/entrada-estoque-filter-dto';
import { FormControlErrorsComponent } from '@shared/components/form-control-errors/form-control-errors.component';

@Component({
  selector: 'app-entrada-estoque-filters',
  imports: [
    //Angular
    FormsModule,
    CommonModule,
  ...
  templateUrl: './entrada-estoque-filters.component.html',
})
export class EntradaEstoqueFiltersComponent implements OnInit {
  ...
  onSubmit() {
    const dto = new EntradaEstoqueFilterDto(this.form.value);
